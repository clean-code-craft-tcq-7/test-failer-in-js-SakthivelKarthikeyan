...
function sensorStubForHighPrecipitation() {
  return {
    temperatureInC: 50,
    precipitation: 61,
    humidity: 26,
...
function testRainy() {
  ...
  console.log(weather);
  expect(weather).includes(
    "rain",
    "Test failed: Expected 'rain' in weather description"
  );
}
...
function testHighPrecipitation() {
  ...
  const weather = report(sensorStubForHighPrecipitation);
